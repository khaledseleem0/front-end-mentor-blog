...
import {NavBar,Logo,Link,Regester,Navbar,Drop,DropDown,Ul,Burger} from './navstyle.js';
...
<NavBar>
<DropDown>
                    <Link to="/Product">Product   <i class="fas fa-sort-down"></i></Link>
            ...
            <DropDown>
            <Link to="/Product">Company<i class="fas fa-sort-down"></i></Link>
                    <Drop>
                        <li>
                        <Link to="/Marketplace">Integrations</Link>
                        </li>
                        <li>
            ...
            <DropDown>
                    <Link to="/Connect">Connect <i class="fas fa-sort-down"></i></Link>
                    <Drop>
                        <li>
                        ...
                        <li>
                        <Link to="/Product">Newsletter</Link>

                        </li>
                    </Drop>
            </DropDown>
            <DropDown>
                    <Link to="/Product">Blog  <i class="fas fa-sort-down"></i></Link>
        ...
        <Regester>
            ...
            <li>
                ...
                <Burger onClick={(e)=>handelToggle(e)}>
                <span></span>
                <span></span>
                <span></span>
              </Burger>
